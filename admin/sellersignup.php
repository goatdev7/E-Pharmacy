...
if(!isset($_SESSION['auth1']) || $_SESSION['auth1']!=true){
    echo "log in first";
...
function test_input($data) {
  ...
  include 'connection.php';
    ...
    if(($password == $confirmpassword) && $exists==false){
      $id=$_SESSION['id'];
         $sql = "UPDATE `seller` SET `username` = '$name', `pass` = '$password', `phoneno` = '$phoneno', `email` = '$email' WHERE `id` = $id";
    //sql query
...
<?php
    ...
    echo ' <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Error!</strong>Passwords Do not matcg
 ...
 <div class="dom">
        <div class="container my-4 bg-primary" style="color:white;font-display:bold;padding:2%;">
            <h1 class="text-center">Seller Sign Up</h1>
        </div>
            <form method="post">
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="email" class="text-center text-light col-lg-2 form-control-sm">Email</label>
                        <input type="text" placeholder="Enter Email" class="col-lg-6 text-center form-control-sm"  id="email" 
                        name="email">
