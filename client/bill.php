...
include 'http://localhost/admin/connection.php';
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <button class="btn btn-outline-warning  my-2 my-sm-0" ><a style="color:white;" href="http://localhost/admin/sellerinfo.php"><b>Update Login Info</b></a></button>
    <button class="btn btn-outline-danger my-2 my-sm-0"><a style="color:white;" href="http://localhost/admin/sellerlogin.php"><b>Log Out</b></a></button>
  </div>
</nav>
<div class="wels">
...
<div class="bills">
  ...
  <div class="col-lg-12 m-auto align-items-center">
    ...
    $invoice='<a href="..\invoice.php" target="_blank" class="btn btn-success">Get Invoice</a> <br></br>';
    $invoice2='<br>
    <div class="corder">
...
if(isset($_POST['indone'])){
  $return="SELECT name, quantity from corders2";
  $runr=mysqli_query($con,$return);
  while($rowsd=mysqli_fetch_assoc($runr)){
    // echo $rowsd['name'];
    $quano=$rowsd['quantity'];
    $nameo=$rowsd['name'];
    $q="UPDATE notes SET quantity = quantity+ $quano WHERE name like '%".$nameo."%'";
    $r=mysqli_query($con,$q);
  }
//   $rows=mysqli_fetch_all($runr, MYSQLI_ASSOC);
// print_r($rows);
  $quer2="DELETE FROM corders2";
...
<div class="invents">
  ...
  <a href=".\meds.php" class="btn btn-success" target="_blank">Show Inventory</a>';
</div>
<!-- Footer -->
